...
- Use the configuration window to choose which glamour plate numbers are eligible for roulette. Empty glamour plates are automatically excluded from random selection.
